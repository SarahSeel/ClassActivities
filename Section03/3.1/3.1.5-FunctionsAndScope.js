...
// ? what do you expect ?
console.log(total); // We expect for an error to be thrown because total is defined in the child scope,
...
function parentAndChildScope() {
  ...
  console.log("Parent Scope, Child Variable:", childVariable); // This statement will not print because
  // child variable is not declared in the global scope
}